...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/empty_list_image.svg
  SvgGenImage get emptyListImage =>
      const SvgGenImage('assets/icons/empty_list_image.svg');

  /// List of all assets
  List<SvgGenImage> get values => [backIcon, deleteIcon, emptyListImage];
}
